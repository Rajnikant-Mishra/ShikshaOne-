...
// import { toast } from "../../components/ui/use-toast"; // Assuming you have this from shadcn/ui like in AddUserForm
...
//         `${API_BASE_URL}/api/v1/users/all?${params}`,
//         {
//           headers: {
...
//               placeholder="Search email / user / role / status"
//               value={search}
//               onChange={(e) => {
...
//                       {user.user_profile ? (
//                         <img
//                           src={`${API_BASE_URL}/profiles/${user.user_profile}`}
//                           alt={user.username}
...
//                       ) : null}
//                       <div
//                         className={`w-8 h-8 rounded-full bg-gray-300 flex items-center justify-center text-xs font-bold text-gray-600 ${
//                           user.user_profile ? "hidden" : "flex"
//                         }`}
//                       >
